...
export function CategoriesSection() {
  return (
    <section id="categorias" className="scroll-mt-16 bg-background py-16 md:py-20">
      <div className="container">
        ...
        <div className="grid grid-cols-1 gap-4 min-[380px]:grid-cols-2 sm:grid-cols-3 md:grid-cols-5">
          {categories.map((cat) => (
            <div
              key={cat.name}
              className="group flex flex-col items-center gap-3 rounded-xl border border-border bg-card p-4 transition-all duration-300 hover:border-primary/30 hover:shadow-lg hover:shadow-primary/5 sm:p-6"
            >
